...
url_odagrants <- "https://sdmx.oecd.org/dcd-public/rest/data/OECD.DCD.FSD,DSD_CRS@DF_CRS,1.1/CAN.DPGC.520+112+122+140+16050.11._T._T.D.Q._T..?startPeriod=2015&dimensionAtObservation=AllDimensions"
...
oda_raw <- read_sdmx(url_odagrants)
